...
const CheckCircleIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{marginRight: '8px', flexShrink: 0}}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
);
    ...
    return (
        <div className="landing-wrapper">
            ...
            <section className="hero-section">
                <div className="hero-content">
                    ...
                    <div className="hero-stats">
                        <StatsCounter end={50} label="Farms Protected" suffix="+" />
                        <StatsCounter end={30} label="Water Saved (Million L)" suffix="M" />
                        <StatsCounter end={99} label="Uptime Reliability" suffix="%" />
                    </div>
                ...
                <div className="section-container">
                    <div className="about-content">
                        ...
                        <p className="section-paragraph">
                            In modern agriculture, efficiency is key. Yet, a significant and often overlooked expense in poultry farming is water loss from undetected leaks in pipeline systems. A minor drip can waste thousands of liters over time, inflating utility bills and straining a precious resource.
                        </p>
                        <p className="section-paragraph">
                            <strong>HydroFlow Guardian</strong> was born from this challenge. It's an intelligent, automated system designed to be your farm's first line of defense. By continuously monitoring pipeline flow, especially during the quiet of the night, it identifies costly leaks and inefficiencies the moment they begin.
                        </p>
                        ...
                        <div className="benefits-list">
                            <div className="benefit-item">
                                <CheckCircleIcon />
                                <span>Reduce water waste by up to 40%</span>
                            </div>
                            <div className="benefit-item">
                                <CheckCircleIcon />
                            ...
                            <div className="benefit-item">
                                <CheckCircleIcon />
                                <span>Instant leak detection and auto shut-off</span>
                            </div>
                            <div className="benefit-item">
                                <CheckCircleIcon />
                                <span>Easy installation with existing infrastructure</span>
                            </div>
                        </div>
                    </div>
            ...
            <section id="features" className="content-section features-section">
                ...
                <p className="section-paragraph" style={{marginBottom: '3rem'}}>
                    Cutting-edge technology designed to protect your resources and maximize efficiency
                </p>
            ...
            <section className="content-section roadmap-section">
                ...
                <p className="section-paragraph" style={{marginBottom: '4rem'}}>
                    Our intelligent system operates in four seamless steps to protect your water resources
                </p>
                <div className="river-flow-container">
                    ...
                    <div className="river-node" style={{ top: '3%', left:'80%' }}>
                        <FlipCard icon={<EyeIcon />} title="1. Monitor" description="High-precision sensors embedded in your pipelines constantly measure water flow with millisecond accuracy." />
                    </div>
                    <div className="river-node" style={{ top: '32%' ,left: '12%'}}>
                        <FlipCard icon={<AlertTriangleIcon />} title="2. Detect" description="The system's AI compares real-time flow against pre-set schedules to find anomalies and unusual patterns." />
                    </div>
                    <div className="river-node" style={{ top: '55%' }}>
                        <FlipCard icon={<ZapOffIcon />} title="3. Act" description="The smart valve controller receives the signal and instantly closes the pipeline to prevent water loss." />
                    </div>
                    <div className="river-node" style={{ top: '78%',left: '10%' }}>
                        <FlipCard icon={<BellIcon />} title="4. Notify" description="A detailed report of the event is sent to your email, ensuring you're always informed and in control." />
                    </div>
                </div>
            </section>
            ...
            <section className="content-section tech-stack-section">
                ...
                <p className="section-paragraph" style={{marginBottom: '3rem'}}>
                    Built with industry-leading frameworks for reliability, speed, and scalability
                </p>
                <div className="tech-grid">
                    <div className="tech-card">
                        <CodeIcon />
                        <h4>Frontend</h4>
                        <p>A sleek, responsive user interface built with <strong>React</strong> and <strong>Vite</strong> for lightning-fast performance and seamless user experience.</p>
                    </div>
                    <div className="tech-card">
                        <DatabaseIcon />
                        <h4>Backend</h4>
                        <p>A robust and scalable server powered by <strong>Node.js</strong> and <strong>Express</strong>, ensuring reliable data processing and real-time updates.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="content-section testimonials-section">
                ...
                <p className="section-paragraph" style={{marginBottom: '3rem'}}>
                    Join hundreds of satisfied farm owners who trust HydroFlow Guardian
                </p>
                <div className="testimonials-grid">
                    ...
                    <div className="testimonial-card">
                        <p className="testimonial-quote">The system paid for itself in just 3 months. The peace of mind knowing our water system is monitored 24/7 is invaluable. Highly recommend!</p>
                        <p className="testimonial-author">- Michael R., Poultry Farm Director</p>
                    </div>
                </div>
            </section>
            ...
            <section id="contact" className="content-section cta-final-section">
                ...
                <p className="section-paragraph">
                    Take control of your farm's water consumption today. Stop guessing and start knowing.<br/>
                    Join the future of smart farming with HydroFlow Guardian.
                </p>
